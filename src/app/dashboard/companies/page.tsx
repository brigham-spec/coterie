...
// Companies — the network's central table (build item 4). The layout has already
// resolved the tenant (React-cached), so requireOrgContext here reuses that
// context; the list reads through withOrg so RLS scopes it to this tenant.
