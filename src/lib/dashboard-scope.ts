...
// their own ("mine") and the whole org ("everyone"), defaulting to everyone.
//
...
/// Resolve the effective scope. Admins honor the requested value and fall back to
/// "everyone"; everyone else is pinned to "mine" regardless of what was asked.
export function resolveScope(
  isAdmin: boolean,
  requested: string | undefined,
): DashboardScope {
  if (!isAdmin) return "mine";
  return requested === "mine" ? "mine" : "everyone";
}
